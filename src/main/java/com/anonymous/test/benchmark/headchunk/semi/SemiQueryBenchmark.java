...
public class SemiQueryBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/springbok/benchmark-log/headchunk/status/geohash-semi-query-random.log", status);
        }
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexWithGeoHashSemiSplit.printStatus();
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/springbok/benchmark-log/headchunk/status/geohash-semi-query-gaussian.log", status);
        }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/springbok/benchmark-log/headchunk/semi/semi-query.log")
                .build();
