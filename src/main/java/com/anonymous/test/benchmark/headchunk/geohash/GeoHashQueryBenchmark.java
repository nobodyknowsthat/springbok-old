...
public class GeoHashQueryBenchmark {
    ...
    public static class BenchmarkStateRandom {
        ...
        public void printStatus() {
            ...
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/springbok/benchmark-log/headchunk/status/geohash-query-random.log", status);
        }
    ...
    public static class BenchmarkStateGaussian {
        ...
        public void printStatus() {
            String status = indexWithGeoHash.printStatus();
            StatusRecorder.recordStatus("/home/anonymous/IdeaProjects/springbok/benchmark-log/headchunk/status/geohash-query-gaussian.log", status);
        }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                ...
                .output("/home/anonymous/IdeaProjects/springbok/benchmark-log/headchunk/geohash/geohash-query.log")
                .build();
